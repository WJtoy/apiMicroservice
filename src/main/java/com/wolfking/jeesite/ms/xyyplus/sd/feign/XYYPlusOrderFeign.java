package com.wolfking.jeesite.ms.xyyplus.sd.feign;

import com.kkl.kklplus.common.response.MSResponse;
import com.kkl.kklplus.entity.common.material.B2BMaterial;
import com.wolfking.jeesite.ms.xyyplus.sd.fallback.XYYPlusOrderFeignFallbackFactory;
 ...
 * 新迎燕B2B微服务接口调用
 */
@FeignClient(name = "kklplus-b2b-xyy-plus", fallbackFactory = XYYPlusOrderFeignFallbackFactory.class)
public interface XYYPlusOrderFeign {
