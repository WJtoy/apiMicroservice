...
public interface AppMyWalletDao extends BaseDao {
    ...
    /**
     * 获取网点的完工总金额与项目数量(新)包含平台费和扣点
     */
    IntegerDoubleTuple getServicePointCompletedChargeFeeSummary(@Param("quarter") String quarter,
                                                             @Param("servicePointId") Long servicePointId,
                                                             @Param("beginCreateDate") Date beginCreateDate,
                                                             @Param("endCreateDate") Date endCreateDate);
    ...
    Double getServicePointTaxFeeSummary(@Param("quarter") String quarter,
                                          @Param("servicePointId") Long servicePointId,
                                          @Param("beginCreateDate") Date beginCreateDate,
                                          @Param("endCreateDate") Date endCreateDate);
     ...
     * （按月份）获取网点的平台管理费
     */
    Double getServicePointInfoFeeSummary(@Param("quarter") String quarter,
                                         @Param("servicePointId") Long servicePointId,
                                         @Param("beginCreateDate") Date beginCreateDate,
                                         @Param("endCreateDate") Date endCreateDate);
