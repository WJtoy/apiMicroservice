...
public class ServicePointStationSender implements RabbitTemplate.ConfirmCallback {
    ...
    public void send(MQSyncServicePointStationMessage.SyncServicePointStationMessage syncServicePointStationMessage) {
        ...
        redisUtilsLocal.incr(RedisConstant.RedisDBType.REDIS_MQ_DB, String.format(RedisConstant.MQ_SS, MQConstant.MS_MQ_ES_SYNC_SERVICEPOINT_STATION));
    }
    ...
    public void confirm(CorrelationData correlationData, boolean ack, String s) {
        if (ack) {
            redisUtilsLocal.incr(RedisConstant.RedisDBType.REDIS_MQ_DB, String.format(RedisConstant.MQ_RS, MQConstant.MS_MQ_ES_SYNC_SERVICEPOINT_STATION));
        } else {
            redisUtilsLocal.incr(RedisConstant.RedisDBType.REDIS_MQ_DB, String.format(RedisConstant.MQ_RE, MQConstant.MS_MQ_ES_SYNC_SERVICEPOINT_STATION));
        }
    }
}
